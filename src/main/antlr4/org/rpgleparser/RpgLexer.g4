...
CS_Operation_DOU: {getCharPositionInLine()>=25 && getCharPositionInLine()<31}? OP_DOU-> type(OP_DOU);
...
CS_Operation_WHEN: {getCharPositionInLine()>=25 && getCharPositionInLine()<31}? OP_WHEN-> type(OP_WHEN);
