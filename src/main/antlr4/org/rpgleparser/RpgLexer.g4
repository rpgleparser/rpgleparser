...
CS_Operation_DOU: {getCharPositionInLine()>=25 && getCharPositionInLine()<31}? OP_DOU-> type(OP_DOU),pushMode(FREE);
...
CS_Operation_RETURN: {getCharPositionInLine()>=25 && getCharPositionInLine()<31}? OP_RETURN-> type(OP_RETURN);
...
CS_Operation_SORTA: {getCharPositionInLine()>=25 && getCharPositionInLine()<31}? OP_SORTA-> type(OP_SORTA);
...
CS_Operation_WHEN: {getCharPositionInLine()>=25 && getCharPositionInLine()<31}? OP_WHEN-> type(OP_WHEN),pushMode(FREE);
...
CS_Operation_XML_INTO: {getCharPositionInLine()>=25 && getCharPositionInLine()<31}? OP_XML_INTO-> type(OP_XML_INTO);
CS_Operation_XML_SAX: {getCharPositionInLine()>=25 && getCharPositionInLine()<31}? OP_XML_SAX-> type(OP_XML_SAX);
